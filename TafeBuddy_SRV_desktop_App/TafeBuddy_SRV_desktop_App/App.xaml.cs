...
namespace TafeBuddy_SRV_desktop_App
{
    /// <summary>
    ...
    {
        public static string connectionString = "server = localhost; user id = root; database = db_tafebuddy";
        ...
        public static string userLogged_profileImage;
