...
-- -----------------------------------------------------
-- Table `db_tafebuddy`.`parchmentRequest`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `db_tafebuddy`.`parchmentRequest` (
  `parchmentRequestNo` INT NOT NULL AUTO_INCREMENT,
  ...
  `NameOfLecturer` VARCHAR(45) NULL,
  `CampusOfStudy` VARCHAR(45) NULL,
  ...
  `student_StudentID1` VARCHAR(9) NOT NULL,
  `qualification_QualCode` VARCHAR(20) NOT NULL,
  INDEX `fk_parchmentRequest_student1_idx` (`student_StudentID1` ASC),
  INDEX `fk_parchmentRequest_qualification1_idx` (`qualification_QualCode` ASC),
  PRIMARY KEY (`parchmentRequestNo`),
  CONSTRAINT `fk_parchmentRequest_student1`
    FOREIGN KEY (`student_StudentID1`)
    REFERENCES `db_tafebuddy`.`student` (`StudentID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_parchmentRequest_qualification1`
    FOREIGN KEY (`qualification_QualCode`)
    REFERENCES `db_tafebuddy`.`qualification` (`QualCode`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
